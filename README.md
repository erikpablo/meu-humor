...
- [x] O usuário poderá fazer login no sistema.  
- [x] O usuário poderá registrar seu humor do dia.  
- [x] O sistema deve impedir que o mesmo usuário registre dois humores no mesmo dia.  
...
- [x] Cada usuário deve ter apenas um registro de humor por dia.  
  → Se já registrou, não pode duplicar para o mesmo dia.  
- [x] O humor só pode ser registrado se o usuário estiver autenticado.  
- [ ] A média exibida deve ser sempre dos últimos 5 registros.  
- [x] O humor do dia deve ser categorizado em uma escala fixa  
